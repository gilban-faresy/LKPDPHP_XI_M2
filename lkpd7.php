<?php 
function kalimat($tanda){
    $panjang = strlen($tanda);
    if($panjang>50){
        $tanda = substr($tanda, 0 , 50) . "...";
    }
    return $tanda;
}
$parag ="It is a long established fact that a reader will be distracted by the readable content of a page when 
